...
// 開発時の簡易対応: Vite (http://localhost:5173) を iframe で埋め込み表示します。
// 注: デプロイ時は iframe が期待どおり動作しない可能性があるため、将来的には
// Vite の内容を Next に移行するか、Next をルートで使う構成に統一することを推奨します。
...
const HomePage: NextPage = () => {
  return (
    <div style={{ fontFamily: "system-ui, -apple-system, 'Segoe UI', Roboto, 'Noto Sans JP', sans-serif", minHeight: '100vh', background: '#f8fafc', color: '#0f172a' }}>
      ...
      {/* iframe を使って Vite の dev サーバーを埋め込む (開発向け) */}
