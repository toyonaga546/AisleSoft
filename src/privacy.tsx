    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
        ...
        <div className="max-w-screen-xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <a href="/" aria-label="トップページへ" className="inline-block">
                <Logo white />
              </a>
            </div>
            ...
            <div className="hidden md:flex items-center gap-8 text-white text-sm">
              ...
              <a href="/careers" className="hover:underline">人材派遣</a>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="mb-4 text-gray-600">
          株式会社アイルソフトは、当社の「品質方針」に掲げる考えのもと、「業務分析およびソフトウェア開発・保守」事業を行っています。当社が事業活動を行う上で、個人情報を適切に取り扱うことは社会的 責務であると考えています。当社では、この責務を全うするために、以下の取り組みを実施します。
        </p>
